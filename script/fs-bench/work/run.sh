...
IMAGE_LEGACY="${IMAGE_LEGACY:-docker.io/stargz/fio:256m-4t-org}"
IMAGE_STARGZ="${IMAGE_STARGZ:-docker.io/stargz/fio:256m-4t-sgz}"
IMAGE_ESTARGZ="${IMAGE_ESTARGZ:-docker.io/stargz/fio:256m-4t-esgz}"
